    ...
    <div className="container mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="bg-muted p-6 rounded-lg">
        ...
        <p className="text-muted-foreground">
          Si conoces algún otro sitio web o recurso que pueda ser de interés para la comunidad de las olimpiadas matemáticas, no dudes en compartirlo con nosotros a través del <a href="mailto:joseperez2000@hotmail.es" className="text-primary hover:underline">correo electrónico</a>. Valoramos tus sugerencias para mejorar esta sección.
        </p>
      </div>
    </div>
  );
